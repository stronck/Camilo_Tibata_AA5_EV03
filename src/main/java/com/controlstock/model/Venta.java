...
public class Venta {
    ...
    public Venta(int id, int clienteId, int productoId, int cantidad, double total, String fecha) {
        this.id = id; this.clienteId = clienteId; this.productoId = productoId; this.cantidad = cantidad; this.total = total; this.fecha = fecha;
    }
